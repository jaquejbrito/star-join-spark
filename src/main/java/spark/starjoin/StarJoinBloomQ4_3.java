...
public class StarJoinBloomQ4_3
{
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        .map( new Function<String, String[]>() {  public String[] call(String line) { return line.split("\\|"); } })
        .filter( new Function<String[], Boolean>() {  public Boolean call(String[] s) {  return s[4].equals("1997") | s[4].equals("1998"); } })        
        ...
        .map( new Function<String, String[]>() {  public String[] call(String line) { return line.split("\\|"); } })
        .filter( new Function<String[], Boolean>() {  public Boolean call(String[] s) {  return s[3].equals("MFGR#14");  } })
        .mapToPair(new PairFunction<String[], String, String>() { public Tuple2<String, String> call(String[] s) { return new Tuple2<String, String>(s[0], s[4]);}});
        ...
        .map( new Function<String, String[]>() {  public String[] call(String line) { return line.split("\\|"); } })
        .filter( new Function<String[], Boolean>() {  public Boolean call(String[] s) {  return varC.value().contains(s[2].getBytes()) & varS.value().contains(s[4].getBytes()) & varP.value().contains(s[3].getBytes()) & varD.value().contains(s[5].getBytes()); } })
        ...
        { String[] v = {s._2._1[1],s._2._1[2],s._2._1[3],s._2._2}; return new Tuple2<String, String[]>(s._2._1[0], v);}});
        ...
        { return new Tuple2<String, Long>(s._2._2+","+s._2._1[1]+","+s._2._1[2],Long.parseLong(s._2._1[0]));}})
