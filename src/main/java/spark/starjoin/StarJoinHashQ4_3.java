...
public class StarJoinHashQ4_3
{
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        { return new Tuple2<String, Long>(varD.value().get(Integer.parseInt(s[5]))+","+varS.value().get(Integer.parseInt(s[4]))+","+varP.value().get(Integer.parseInt(s[3])), Long.parseLong(s[12])-Long.parseLong(s[13]));}});
