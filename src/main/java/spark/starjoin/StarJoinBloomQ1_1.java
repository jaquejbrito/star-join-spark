...
public class StarJoinBloomQ1_1
{
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        .map( new Function<String, String[]>() {  public String[] call(String line) { return line.split("\\|"); } })
        .filter( new Function<String[], Boolean>() {  public Boolean call(String[] s) {  return Integer.parseInt(s[11]) <= 3 & Integer.parseInt(s[11]) >=1  & Integer.parseInt(s[8]) < 25 & varD.value().contains(s[5].getBytes()); } })
