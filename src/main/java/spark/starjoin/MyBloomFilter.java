...
/* Original source: https://github.com/MagnusS/Java-BloomFilter/blob/master/src/com/skjegstad/utils/BloomFilter.java */
...
static class BloomFilter<E> implements java.io.Serializable {
    ...
    public void or(BloomFilter filter) {
        if(filter != null
            ...
            && filter.bitSetSize == this.bitSetSize
            && filter.k == this.k) {
        } else {
            throw new IllegalArgumentException("filters cannot be or-ed");
        }
        bitset.or(((BloomFilter) filter).bitset);
    }
   ...
   public static class BloomFilterRegistrator implements KryoRegistrator {
        public void registerClasses(Kryo kryo) {
          kryo.register(MyBloomFilter.BloomFilter.class, new FieldSerializer(kryo, MyBloomFilter.BloomFilter.class));
        }
