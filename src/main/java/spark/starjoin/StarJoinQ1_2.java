...
public class StarJoinQ1_2
{
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        .map( new Function<String, String[]>() {  public String[] call(String line) { return line.split("\\|"); } })
        .filter( new Function<String[], Boolean>() {  public Boolean call(String[] s) {  return Integer.parseInt(s[11]) <= 6 & Integer.parseInt(s[11]) >= 4  & Integer.parseInt(s[8]) <= 35 & Integer.parseInt(s[8]) >= 26; } })
